...
namespace Miic.Friends.Moments
{
    public interface IPublishInfo : ICommon<PublishInfo>, ICommon<AccessoryInfo>
    {
        ...
        /// <param name="page">分页，默认不分页</param>
        /// <returns>发布信息列表</returns>
        DataTable GetPersonMomentsPublishInfosWithComment(GeneralDateView dateView, MiicPage page = null);
        /// <summary>
        /// 获取某人的朋友圈发布信息数
        /// </summary>
        /// <param name="dateView">日期视图</param>
        /// <returns>发布信息列表数</returns>
        int GetPersonMomentsPublishWithCommentCount(GeneralDateView dateView);
        /// <summary>
        /// 获取年份列表
        /// </summary>
