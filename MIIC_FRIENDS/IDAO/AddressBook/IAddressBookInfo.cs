   ...
   public   interface IAddressBookInfo:ICommon<AddressBookInfo>,ICommon<AddressBookApplicationInfo>
    {
       ...
       DataTable GetOftenUsedAddressBookList(string userID,int top=15);
       /// <summary>
       /// 获取某人的所有经常联系通讯录列表
       /// </summary>
       /// <param name="userID">用户ID</param>
       ...
       DataTable GetPersonAllAddressBookList(string userID);
       /// <summary>
       /// 获取某人/我的所有通讯录列表数
       /// </summary>
       /// <param name="userID">用户ID</param>
       /// <returns>通讯录列表</returns>
       int GetPersonAllAddressBookCount(string userID);
       /// <summary>
       /// 搜索我的/某人的通讯录组信息列表
       /// </summary>
