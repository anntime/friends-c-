    ...
    public partial class GroupInfoDao : RelationCommon<GroupInfo, GroupMember>, IGroupInfo
    {
        ...
        bool ICommon<GroupMember>.Insert(GroupMember member)
        {
            ...
            if (result == true)
            {
                ...
                //IopenIMGroupInfo.Join(new OpenIMCommonTribeInfo()
                //{
                //    TribeID = temp.TribeID,
        ...
        bool ICommon<GroupMember>.Delete(string id)
        {
            ...
            try
            {
                tempMember = ((ICommon<GroupMember>)this).GetInformation(id);
                if (tempMember != null)
                {
            ...
            if (result == true)
            {
                ...
                string groupCode = string.Empty;
                //IopenIMGroupInfo.Quit(new OpenIMCommonTribeInfo()
                //{
                //    TribeID = tempGroup.TribeID,
                //    UserID = tempMember.MemberID
                //}, out groupCode);
            }
            return result;
        }
        ...
        public bool Insert(string groupID, List<GroupMember> members)
        {
            ...
            try
            {
                temp = ((ICommon<GroupInfo>)this).GetInformation(groupID);
                if (temp != null)
                {
