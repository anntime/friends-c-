...
AtInfo.Init = function init() {
    ...
    //@切换事件
    $("#liAtMoments").off("click").on("click", AtInfo.Moments.TagEvent);
    $("#liAtCommunity").off("click").on("click", AtInfo.Community.TagEvent);
    $("#liAtGroup").off("click").on("click", AtInfo.Group.TagEvent);
    $("#spnReadAll").off("click").on("click", AtInfo.ReadAllEvent);
    //触发朋友圈点击事件
...
AtInfo.ReadEvent = function ReadEvent(event) {
    ...
    var business_type = event.data.Type;
    AtInfo.SetRead(id, business_type);
