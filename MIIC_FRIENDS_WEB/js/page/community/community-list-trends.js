        ...
        "{searchView:" + $.Serialize(keyword) + "}",
         function (json) {
             ...
             if (result > Community.Trends.PageSize) {
                 ...
                 $(document).off("scroll").on("scroll", { Keyword: keyword }, Community.Trends.ScrollEvent);
             } 
         });
}
//滚轮事件
Community.Trends.ScrollEvent = function ScorllEvent(event) {
    ...
    if (($(document).scrollTop() >= $(document).height() - $(window).height()) && Community.Trends.OldDocumentHeight != $(document).height()) {
        if (Community.Trends.CanPageLoad == true) {
            ...
            Community.Trends.SearchBind(keyword, page, Community.Trends.CurrentIndex);
          ...
          if (result != null) {
              ...
              $.each(result, function (index, item) {
                  ...
                  if (item.TopicInfoList != null) {
                      ...
                      $(document).on("click", "#divCommunityTopic" + Index, { Community: community_event_info,Type: Enum.CommunitySubType.Topic, Labels: item.LabelInfoList}, Community.Label.GoDetailEvent);
